    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="#">Alta de materias</a></li>
		...
		<form name="formulario" method="post" action="resultado.php">
			...
			<div class="col-sm-3"><select name="carrera" id="carrera" class="form-control required">
	...
	$conn->close();
				...
				?>
						...
						<div class="form-group row">
							...
							<div class="col-sm-9"><input type="text" placeholder="Inserte nombre" id="materia" name="nombreMateria" class="form-control"></div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<select name="cargaHoraria" id="cargaHoraria" class="form-control required">
									<option value="">Seleccione Carga Horaria</option>
		...
		<center>
		<button id="env" type="submit" value="Submit" class="btn btn-primary" disabled>Enviar</button>
